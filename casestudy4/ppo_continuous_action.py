...
if __name__ == "__main__":
    ...
    args.num_iterations = args.total_timesteps // args.batch_size # 1e6 // 2048 = 488
    ...
    # Reward Setup
    reward_funciton = RewardFunction(env=envs, args = args, device = device)
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            reward_orig = rewards
            with torch.no_grad():
                reward = reward_funciton.observe_reward(obs[0], actions[0], next_obs)        
